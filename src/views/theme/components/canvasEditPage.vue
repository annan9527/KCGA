<template>
  <div class="layout hom-layout" style="margin: 0 auto">
    <!-- 头部 -->
    <div class="heard">
      <div class="KCGA">
        <img
    ...
    <div class="footer">
      <div class="heard">
        <div class="item">
          全国导航
          <span>
            <img src="@/assets/img/底部更多.png" alt="" />
          </span>
        </div>
        <div class="item">
          省内导航
      ...
      <div class="main">
        ...
        <div
          style="margin-bottom: 0px font-size: 9px;
           ...
           color: #141516;"
        >
          技术支持:柯城分局网警大队 地址:衢州市柯城区亭川东路398号
        </div>
        <div
          style="
            margin-bottom: 10px;
...
.footer {
  ...
  .heard {
    width: 1200px;
    height: 31px;
    background: linear-gradient(0deg, #3671cf 0%, #3c7ee8 100%);
