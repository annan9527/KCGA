  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="编号">
        <el-input size="small" v-model="formInline.number" placeholder="请输入编号"></el-input>
      </el-form-item>
      <el-form-item label="物品名">
        <el-input size="small" v-model="formInline.deptNo" placeholder="请选择物品名"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="number" label="编号"  align="center" width="300">
      </el-table-column>
      <el-table-column sortable prop="deptNo" label="物品名"  align="center" width="300">
      </el-table-column>
      <el-table-column sortable prop="editTime" label="申报时间"  align="center" width="300">
        <template slot-scope="scope">
          <div>{{scope.row.editTime|timestampToTime}}</div>
        </template>
      </el-table-column>
      <el-table-column sortable prop="articleTitle" label="申报人" align="center"  width="300">
      </el-table-column>
