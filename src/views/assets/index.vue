<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="deptNo" label="物品名" width="300">
      </el-table-column>
      <el-table-column sortable prop="editTime" label="购买时间" width="300">
       
      </el-table-column>
      <el-table-column sortable prop="articleTitle" label="采购人" width="300" align="center">
      </el-table-column>
