...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable prop="deptNo" label="文件名" width="300">
      </el-table-column>
      <el-table-column sortable prop="editTime" label="上传时间" width="300">
      </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="文件名" prop="deptNo">
          <el-input
            size="small"
        ...
        <el-form-item label="文件" style="height: 300px;">
          <!-- 富文本编辑器 -->
          <Edit></Edit>
        </el-form-item>
        ...
        data: [
          {
            ...
            deptNo: "公安部印发关于公安机关执行《人民警察法》有关问题的解释的通知",
            parentId: 1,
          },
          {
            addUser: null,
          ...
          },
          {
            ...
            deptNo: "公安部印发关于公安机关执行《人民警察法》有关问题的解释的通知通告",
            parentId: 1,
          },
          {
            addUser: null,
