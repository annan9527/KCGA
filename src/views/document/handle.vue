  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      ...
      <el-form-item label="发 送 人">
        <el-input size="small" v-model="formInline.deptNo" placeholder="输入发送人名称"></el-input>
      </el-form-item>
    ...
    >
      ...
      <el-table-column sortable prop="deptName" label="公文编号" width="150"></el-table-column>
      <el-table-column sortable prop="currentState" label="当前状态" width="200"></el-table-column>
      <el-table-column sortable prop="category" label="文件标题" width="450" align="center"></el-table-column>
      <el-table-column sortable prop="docNumber" label="文件文号" width="160"></el-table-column>
